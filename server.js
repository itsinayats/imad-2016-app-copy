  ...
  <!--NAVBAR ENDS  -->
   ...
   <div class="container-fluid">
	<div class="row">
      ...
      <ul class="nav nav-stacked affix" style="position:fixed">
      <br>  <br>  <br>  <br>
      <button class="btn btn-info btn-lg affix s " data-toggle="collapse" data-target="#demo" data-offset="100"><h3>Categories</h3></button>
